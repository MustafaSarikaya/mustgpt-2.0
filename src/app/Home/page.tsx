...
import { Title, Text, rem, Center, Stack, Group, Box, Avatar, Flex } from '@mantine/core';
...
export default function Home() {
    ...
    return (
        <Flex align='center' px={0} h="80vh" w={'100%'} direction={'column'} pt={'20dvh'}>
            {/* <Stack gap="xl" px='xs' maw={rem(640)} w="100%" align='center'> */}
